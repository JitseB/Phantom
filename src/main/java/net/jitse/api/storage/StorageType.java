...
import net.jitse.phantom.spigot_old.storage.database.HikariStorage;
import net.jitse.phantom.spigot_old.storage.database.MySqlStorage;
import net.jitse.phantom.spigot_old.storage.file.SqliteStorage;
